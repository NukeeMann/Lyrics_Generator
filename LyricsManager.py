...
class LyricsManager:
    ...
    def load_file(self,file_name, phon_name, dict, rhyme_dict):
        ...
        for bword, word, first, second, third, rhyme_word in zip(words[0:], words[1:], words[2:], words[3:], words[4:],
                                                                 phonetics[1:]):
    ...
    def generate_word(self, dict, base_word, rhyme_words, prev_word, prev_rhyme):
        ...
        for n1word in first_nwords.keys():
            if n1word in rhyme_words and n1word != prev_rhyme and n1word in dict[
                prev_word].get_second_word_dic().keys():
                return n1word
